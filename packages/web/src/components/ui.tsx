...
/** The one incident/case status pill — same tone vocabulary as CheckInStatusPill (Pending/Under review/Resolved/Denied), used on both the filer's "My Reports" list and the commissioner's queue. */
