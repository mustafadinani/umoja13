 ...
 * hotspot — nothing is scheduled there. Field 7 is its own distinct tile on
 * the map, NOT the same spot field 5 occupies (5 and 7 are different
 * physical fields, confirmed by pixel-sampling the map image directly) — an
 * earlier pass wrongly assumed the venue's field-5-to-7 reallocation kept
 * the same physical spot and just relabeled it; it didn't.
 */
